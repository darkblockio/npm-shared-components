...
const RegistrationSteps = ({ url, walletAddress, handleClose }) => {
    ...
    const [steps, setSteps] = useState([
        ...
        { 
            n: 2,
            name: 'Log in to Amazon.com with same account', 
            active: false, 
            icon: faCircle, 
            components: [
                { type: 'p', content: 'Make sure you are logged in to the same Amazon account on Amazon.com in the browser and then go to this link:' },
        ...
        { 
            ...
            components: [
                ...
                { type: 'button', name: 'ebooks@darkblock.io', onClick: copyToClipboard },
          ...
          <>
           <div style={{ textAlign: "center", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center" }}>
            ...
            <h1>Connect your Kindle email address</h1>
                      <p className="Darkblock-BodyText">One-time setup.</p>
                      <p
